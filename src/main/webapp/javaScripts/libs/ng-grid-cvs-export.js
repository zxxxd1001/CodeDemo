        ...
        function getProperty(object, property) {
            if (object === null || object === undefined || object === "") {
                ...
                if(property.indexOf("|")>=0){
                    ...
                    temp = property.split('|');
                    var filters = temp[1];
//                    filters.substr(filters.indexOf(":")+1)
//                && property.indexOf(".")>=0
                    if(property.indexOf(".")>=0){
                        properties = temp[0].split('.');
                        return $filter(filters.substr(0,filters.indexOf(":")))(object[properties[0]][properties[1]],filters.substr(filters.indexOf(":")+1));
                    }else{
                        $filter(filters.substr(0,filters.indexOf(":")))(temp[0],filters.substr(filters.indexOf(":")+1));
                    }
        ...
        function showDs() {
            ...
            for (var f in grid.config.columnDefs) {
                ...
                titles.push(grid.config.columnDefs[f].displayName);
            }
            var csvData = '';
            ...
            csvDataLinkHtml += "<br><a href=\"data:text/csv;charset=GBK,";
